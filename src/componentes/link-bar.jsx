...
export default function LinkBar() {
  return (
    <section className="w-full flex flex-wrap gap-2 justify-evenly items-center ">
      ...
      <div className="w-28 h-12 flex items-center justify-start px-2 py-4 outline-2 outline-x-link text-x-link rounded-lg shadow-md hover:cursor-pointer hover:bg-x-link/10 transition-all duration-300">
        <GitHubIcon />
        <h3 className="text-xs">REPO</h3>
      </div>
      <div className="w-28 h-12 flex items-center justify-start px-2 py-4 outline-2 outline-x-link text-x-link rounded-lg shadow-md hover:cursor-pointer hover:bg-x-link/10 transition-all duration-300">
        <YouTubeIcon />
        <h3 className="text-xs">LinkBar</h3>
      </div>
    </section>
  );
}
